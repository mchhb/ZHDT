...
#define PROID		"admin"							// Éè±¸È«³Æ//Ö®Ç°ÓÃ»§ÃûÊÇ£º96ppxbd/s001
extern u32 Lock_Code;
#define AUTH_INFO	"password"	// APIÃÜÔ¿  //Ö®Ç°ÃÜÂëÊÇc8opPYlA7ejO7RxAmMjynNBBf015UaGf04UxAIowQIU=
char DEVID_TEST[50];
//#define DEVID		
//char *DEVID;
//#define DEVID		"DeviceClient100"	// ÈÙÒ«ÌìµØÉè±¸ID 002ºÅ
